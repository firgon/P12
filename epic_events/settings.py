...
SECRET_KEY = 'django-insecure-txj48x1!b53zo3&6q695(5^j8)&xrs+2+#k6@e!)8pjhhu&*0q'
...
MIDDLEWARE = [
    ...
    'epic_events.middleware.EpicEventsMiddleware',
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'epic_events/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
AUTH_USER_MODEL = 'authentication.CRMUser'
